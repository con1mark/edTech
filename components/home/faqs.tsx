...
export default function FAQSection() {
  ...
  const chevronVariant = reduceMotion
    ? {}
    : { open: { rotate: 180 }, closed: { rotate: 0 } };

  const contentVariant = reduceMotion
    ? {}
    : {
          ...
          return (
            <div
              ...
              className={`bg-white dark:bg-gray-800 shadow-sm rounded-xl border
                 overflow-hidden transition-transform transform hover:-translate-y-0.5
            ...
            >
              <button
                ...
                className="w-full flex items-center justify-between px-5 py-4 text-left focus:outline-none
                  focus-visible:ring-2 focus-visible:ring-orange-300 focus-visible:ring-offset-2 rounded-xl"
              >
